...
def Update_GUI_files(repo_url, root, ID_file, repo_SHA, delete_dir_function):
    ...
    update_files = {
        ...
        str(os.path.join(root, 'Launcher.py')): str(os.path.join(temp_dir, 'GUI_V2', 'Launcher.py')), #GUI launcher
        str(os.path.join(root, 'gui', 'Update.py')): str(os.path.join(temp_dir, 'GUI_V2', 'gui', 'Update.py')), #Update function
        str(os.path.join(root, 'gui', 'Mobcal.py')): str(os.path.join(temp_dir, 'GUI_V2', 'gui', 'Mobcal.py')), #GUI layout file
        str(os.path.join(root, 'mfj_creator', 'mfj_creator.py')): str(os.path.join(temp_dir, 'GUI_V2', 'mfj_creator', 'mfj_creator.py')), #mfj creator .py file
        str(os.path.join(root, 'mfj_creator', 'Python', 'Main.py')): str(os.path.join(temp_dir, 'GUI_V2', 'mfj_creator', 'Python', 'Main.py')), #.mfj creator .py function
        str(os.path.join(root, 'mfj_creator', 'Python', 'xyz_to_mfj.py')): str(os.path.join(temp_dir, 'GUI_V2', 'mfj_creator', 'Python', 'xyz_to_mfj.py')), #.mfj creator xyz to mfj converter
        str(os.path.join(root, 'mfj_creator', 'Python', 'mass.prm')): str(os.path.join(temp_dir, 'GUI_V2', 'mfj_creator', 'Python', 'mass.prm')), # param file with MMFF94 atom mass info
        str(os.path.join(root, 'mfj_creator', 'Python', 'vdW.prm')): str(os.path.join(temp_dir, 'GUI_V2', 'mfj_creator', 'Python', 'vdW.prm')), # param file with MMFF94 atom vdW info
        str(os.path.join(root, 'output_analyzer', 'mout_Analyser.py')): str(os.path.join(temp_dir, 'GUI_V2', 'output_analyzer', 'mout_Analyser.py')), #mout analyzer .py file
    }
